// sss3@0.0.1/build/service/user.js
loader.define("sss3@0.0.1", "build/service/user.js", "4", function(require, global, __project, __filename, __dirname, __base, __pixel_ratio){
	"use strict";
	
	return [
		// build/service/user.js
		function(__inner_require__, exports, module){
			...
			var __util__ = Util.pageUtil("sss3/build/service/user");
