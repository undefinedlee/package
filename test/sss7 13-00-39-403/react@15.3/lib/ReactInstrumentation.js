	...
	return [
		...
		function(__inner_require__, exports, module){
			...
			if (process.env.NODE_ENV !== 'production') {
			  var ReactDebugTool = __inner_require__(1 /*lib/ReactDebugTool.js*/);
		...
		function(__inner_require__, exports, module){
			var ReactInvalidSetStateWarningHook = __inner_require__(2 /*lib/ReactInvalidSetStateWarningHook.js*/);
			var ReactHostOperationHistoryHook = __inner_require__(3 /*lib/ReactHostOperationHistoryHook.js*/);
			var ReactComponentTreeHook = require('react@15.3/lib/ReactComponentTreeHook.js');
			var ReactChildrenMutationWarningHook = __inner_require__(4 /*lib/ReactChildrenMutationWarningHook.js*/);
