// event-target-shim@1/lib/event-target.js
loader.define("event-target-shim@1", "lib/event-target.js", "0", function(require, global, __project, __filename, __dirname, __base, __pixel_ratio){
	"use strict";
	...
	return [
		...
		function(__inner_require__, exports, module){
			...
			var Commons = __inner_require__(1 /*lib/commons.js*/);
			var CustomEventTarget = __inner_require__(2 /*lib/custom-event-target.js*/);
			var EventWrapper = __inner_require__(3 /*lib/event-wrapper.js*/);
		...
		// lib/event-wrapper.js
		function(__inner_require__, exports, module){
			//-----------------------------------------------------------------------------
			// Requirements
			//-----------------------------------------------------------------------------
			
			var createUniqueKey = __inner_require__(1 /*lib/commons.js*/).createUniqueKey;
