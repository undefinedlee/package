// react-native@0.21/Libraries/JavaScriptAppEngine/Initialization/SourceMapsCache.js
loader.define("react-native@0.21", "Libraries/JavaScriptAppEngine/Initialization/SourceMapsCache.js", "14", function (require, global, __project, __filename, __dirname, __base, __pixel_ratio) {

	return [
	// Libraries/JavaScriptAppEngine/Initialization/SourceMapsCache.js
	function (__inner_require__, exports, module) {
		var getObjectValues = __inner_require__(1 /*Libraries/vendor/core/getObjectValues.js*/);
		var SourceMapsUtils = __inner_require__(2 /*Libraries/JavaScriptAppEngine/Initialization/SourceMapsUtils.js*/);
		...
		var SourceMapsCache = {
			...
			fetch: function fetch(_ref) {
				var text = _ref.text,
				    url = _ref.url,
				    fullSourceMappingURL = _ref.fullSourceMappingURL;
	...
	// Libraries/JavaScriptAppEngine/Initialization/SourceMapsUtils.js
	function (__inner_require__, exports, module) {
		var HMRClient = require('react-native@0.21/Libraries/Utilities/HMRClient.js');
		var Promise = require('react-native@0.21/Libraries/Promise.js');
		var NativeModules = require('react-native@0.21/Libraries/BatchedBridge/BatchedBridgedModules/NativeModules.js');
		var SourceMapConsumer = __inner_require__(3 /*Libraries/JavaScriptAppEngine/Initialization/SourceMap.js*/).SourceMapConsumer;
		var SourceMapURL = __inner_require__(4 /*Libraries/JavaScriptAppEngine/Initialization/source-map-url.js*/);
