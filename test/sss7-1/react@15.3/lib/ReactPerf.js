__d("react@15.3/lib/ReactPerf.js", ["object-assign@4/index.js", "react@15.3/lib/ReactDebugTool.js", "fbjs@0.8/lib/warning.js"], function(require, global, __project, __filename, __dirname, __base, __pixel_ratio){
	"use strict";
			...
			function printOperations(flushHistory) {
			  ...
			  var table = stats.map(function (stat) {
			    return {
			      'Owner > Node': stat.key,
			      'Operation': stat.type,
			      'Payload': babelHelpers.typeof(stat.payload) === 'object' ? JSON.stringify(stat.payload) : stat.payload,
