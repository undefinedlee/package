loader.define("react-native@0.33/Libraries/vendor/core/Map.js", ["react-native@0.33/Libraries/vendor/core/guid.js", "react-native@0.33/__fbjs__/lib/isNode.js", "react-native@0.33/Libraries/vendor/core/toIterator.js", "react-native@0.33/Libraries/vendor/core/_shouldPolyfillES6Collection.js"], function (require, global, __project, __filename, __dirname, __base, __pixel_ratio) {
	...
	function (__inner_require__, exports, module) {
		...
		module.exports = function (global, undefined) {
			...
			var OLD_IE_HASH_PREFIX = 'IE_HASH_';var Map = function () {
				...
				function Map(iterable) {
					...
					if (iterable != null) {
						...
						initMap(this);
					} }, { key: 'has', value: function has(key) {
					...
					} }, { key: 'delete', value: function _delete(key) {
						var index = getIndex(this, key);
						if (index != null && this._mapData[index]) {
					...
					} }, { key: 'forEach', value: function forEach(callback, thisArg) {
			...
			Map.prototype[toIterator.ITERATOR_SYMBOL] = Map.prototype.entries;var MapIterator = function () {
