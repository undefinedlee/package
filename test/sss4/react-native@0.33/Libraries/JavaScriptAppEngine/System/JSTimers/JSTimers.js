loader.define("react-native@0.33/Libraries/JavaScriptAppEngine/System/JSTimers/JSTimers.js", ["react-native@0.33/Libraries/BatchedBridge/BatchedBridgedModules/NativeModules.js", "react-native@0.33/Libraries/JavaScriptAppEngine/System/JSTimers/JSTimersExecution.js"], function (require, global, __project, __filename, __dirname, __base, __pixel_ratio) {

	return [
	// Libraries/JavaScriptAppEngine/System/JSTimers/JSTimers.js
	function (__inner_require__, exports, module) {
		var RCTTiming = require('react-native@0.33/Libraries/BatchedBridge/BatchedBridgedModules/NativeModules.js').Timing;
		...
		var JSTimers = {
			...
			_clearTimerID: function _clearTimerID(timerID) {
				...
				if (index !== -1) {
					...
					if (type !== JSTimersExecution.Type.setImmediate && type !== JSTimersExecution.Type.requestIdleCallback) {
